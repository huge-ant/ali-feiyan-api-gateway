...
public class SignUtil {
    ...
    public static String sign(String secret, String method, String path, 
        ...
        try {
            ...
            hmacSha256.init(new SecretKeySpec(keyBytes,Constants.HMAC_SHA256));
    ...
    public static void main(String[] args) {
        try {
            String secret = "c238734366dab02863b0272b1d22ac7b";
            String message = "POST##gQljJGbEKNcKlYxdfrZikQ==#application/json#1571196224574#x-ca-key:27913031#x-ca-nonce:2870ea01-dfd0-4b06-a217-310057bf7ac8#x-ca-signaturemethod:HmacSHA256#/cloud/token";
