...
public class Demo {
    ...
    public void getToken() throws Exception {
        ...
        String body = "{\"id\":\"1509086454180\",\"version\":\"1.0\",\"request\":{\"apiVer\":\"1.0.0\"},\"params\":{\"grantType\":\"project\",\"res\":\"a124mCmKp3GjHD9y\"}}";
...
//        CUSTOM_HEADERS_TO_SIGN_PREFIX.add("Content-Type");
        CUSTOM_HEADERS_TO_SIGN_PREFIX.add("Content-MD5");
        ...
        CUSTOM_HEADERS_TO_SIGN_PREFIX.add("X-Ca-SignatureMethod");
